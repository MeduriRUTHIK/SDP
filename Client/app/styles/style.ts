export const styles = {
  ...
  button:
    'flex flex-row justify-center items-center py-3 px-6 mt-[28px] rounded-full curser-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] font-Poppins font-semibold cursor-pointer',
};
