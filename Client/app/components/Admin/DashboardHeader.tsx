...
const DashboardHeader: FC<Props> = () => {
  ...
  return (
    <div className='w-full flex items-center justify-end p-6 fixed top-5 right-0'>
      ...
      {open && (
        <div className='800px:w-[350px] w-[250px] h-auto pb-[40px] dark:bg-[#111c43] bg-white shadow-xl absolute top-16 z-10 rounded'>
          ...
          <div className='dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]'>
            ...
            <p className='px-2 text-black dark:text-white'>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, soluta quaerat? Fugit corporis
              harum veritatis fuga quaerat nostrum! Dolor, a.
            </p>
            <p className='p-2 text-black dark:text-white text-[14px]'>2 days ago</p>
          </div>
