...
// update access token
export const updateAccessoken = CatchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
// update user role --only admin  -- turned with email not _id
